            ...
            <nav class="navbar navbar-expand-lg">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php">
                        <strong><span>Inspire</span> Studio</strong>
                    </a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="products.php">Paintings</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="add.php">Add painting</a>
                            </li>
                        </ul>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">Cool ART</h1>

                                    <p class="lead text-white mt-lg-3 mb-lg-5"> From captivating paintings to inspiring sculptures, our gallery is home to a diverse collection of art pieces crafted by talented.<p>
                ...
                <div class="slick-custom">
                    ...
                    <div class="slick-bottom">
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">New paintings</h1>

                                    <p class="lead text-white mt-lg-3 mb-lg-5">Dive, and invites you to see the world from a different perspective. Start your journey now and find the perfect artwork that resonates with you.</p>

                                    <a href="product.php" class="btn custom-btn">Explore ART</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="mb-5">Get started with <span>Inspire</span>Studio</h2>
                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                <h4 class="mb-3">Good <span>Design</span> <br>Ideas for <span>your</span> ART</h4>

                                                <p>Little ART templates comes with <a href="sign-in.php">sign in</a> / <a href="sign-up.php">sign up</a> pages, paintings listing / paintings detail, about, FAQs, and contact page.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <div class="ratio ratio-16x9">
                                                <iframe src="https://www.youtube.com/watch?v=0La-IS6BAgY&t=748s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p>Over three years in business, We’ve had the chance to work on a variety of paintings, with companies</p>

                                                <p>Custom work is creating Art.</p>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <div class="skill-thumb mt-3">
                                                    ...
                                                    <strong>Colors & Canvas</strong>
                                                        <span class="float-end">70%</span>
                                                            <div class="progress">
                                                                <div class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" style="width: 70%;"></div>
                                                            </div>

                                                    <strong>Online Selling</strong>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="px-5 py-5 py-lg-0">
                                ...
                                <p class="lead mb-4">Credits go to Unsplash and FreePik websites for images used in this Inspire Studio by Tooplate.</p>
            ...
            <section class="featured-product section-padding">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-12 text-center">
                            <h2 class="mb-5">Our Paintings</h2>
                        </div>
                                ...
                                <div class="product-info d-flex">
                                    <div>
                                        <h5 class="product-title mb-0">
                                            <a href="product-detail.php" class="product-title-link">Starry eye</a>
                                        </h5>

                                        <p class="product-p">Van Gog</p>
                                    </div>
                        ...
                        <div class="col-12 text-center">
                            <a href="products.php" class="view-all">View All Paintings</a>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-10 me-auto mb-4">
                        <h4 class="text-white mb-3"><a href="index.php">Inspire</a> Studio</h4>
                    ...
                    <div class="col-lg-5 col-8">
                        ...
                        <ul class="footer-menu d-flex flex-wrap">
                            ...
                            <li class="footer-menu-item"><a href="#" class="footer-menu-link">Paintings</a></li>
