                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 header-info">
                            <h1>
                                <span class="d-block text-primary">Inspire</span>
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                ...
                                <div class="team-info">
                                    ...
                                    <strong class="text-muted">Water color</strong>
                        ...
                        <div class="col-lg-4 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                ...
                                <div class="team-info">
                                    ...
                                    <strong class="text-muted">Acrylic</strong>
                        ...
                        <div class="col-lg-4 mb-lg-0 mb-4 col-12">
                            <div class="team-thumb d-flex align-items-center">
                                ...
                                <div class="team-info">
                                    ...
                                    <strong class="text-muted">Pastel</strong>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-9 mx-auto col-11">
                            <h2 class="text-center">Customer love, <br> <span>Inspire</span>Studio</h2>
                            ...
                            <div class="slick-testimonial">
                                <div class="slick-testimonial-caption">
                                    ...
                                    <div class="slick-testimonial-client d-flex align-items-center mt-4">
                                        ...
                                        <span>George, <strong class="text-muted">Digital Art</strong></span>
                                    </div>
                                </div>
                                ...
                                <div class="slick-testimonial-caption">
                                    ...
                                    <div class="slick-testimonial-client d-flex align-items-center mt-4">
                                        ...
                                        <span>Sandar, <strong class="text-muted">Zoom Paintings Idea</strong></span>
                                    </div>
                                </div>
                                ...
                                <div class="slick-testimonial-caption">
                                    ...
                                    <div class="slick-testimonial-client d-flex align-items-center mt-4">
                                        ...
                                        <span>Marie, <strong class="text-muted">Art </strong></span>
                                    </div>
                                </div>
                                ...
                                <div class="slick-testimonial-caption">
                                    ...
                                    <div class="slick-testimonial-client d-flex align-items-center mt-4">
                                        ...
                                        <span>Catherine, <strong class="text-muted">ART Paintings</strong></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-10 me-auto mb-4">
                        <h4 class="text-white mb-3"><a href="index.html">Inspire Studio</a> Fashion</h4>
