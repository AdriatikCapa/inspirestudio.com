                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="products.html">Paintings</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="add.html">Add painting</a>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12">
                            <h1>
                                ...
                                <span class="d-block text-dark">stop</span>
                            </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="accordionGeneralOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionGeneral">
                                        ...
                                        <div class="accordion-body">
                                            <p class="large-paragraph"><strong>Inspire Studio</strong> Discover a world of art where creativity knows no bounds. From captivating paintings to inspiring sculptures, our gallery is home to a diverse collection of art pieces crafted by talented artists from around the globe. Whether you're an art enthusiast, a seasoned collector, or simply looking to decorate your space with unique pieces, you'll find something that speaks to your soul.</p>
                            ...
                            <h2 class="mt-5">About <span>our paintings</span></h2>
